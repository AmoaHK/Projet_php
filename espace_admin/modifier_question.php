<?php 
            ...
            else echo "Echec de la récupération de l'identifiant de la question.";
      ...
      elseif(empty($rep))
         ...
         try{
                       ...
                       //$rep = $idCnx->quote($rep);
                        ...
                        /*$sql1 = "UPDATE question SET ID_CATEGORIE = $categorie, LIB_QUESTION=$libelle, TYPE_QUESTION = $type, BN_REPONSE = $rep WHERE ID_QUESTION = $id_question";
                        $sql2 = "UPDATE reponse SET LIB_REPONSE_A=$reponse_A, LIB_REPONSE_B=$reponse_B, LIB_REPONSE_C=$reponse_C, LIB_REPONSE_D=$reponse_D WHERE ID_QUESTION = $id_question";*/
                        /*$sql1 = "UPDATE question SET ID_CATEGORIE = '$categorie', LIB_QUESTION=$libelle, TYPE_QUESTION = $type, BN_REPONSE = $rep WHERE ID_QUESTION = " . $idCnx->quote($id_question);*/
                        $sql1 = "UPDATE question SET ID_CATEGORIE = '$categorie', LIB_QUESTION=$libelle, TYPE_QUESTION = $type, BN_REPONSE = $rep WHERE ID_QUESTION = $id_question";
                        $sql2 = "UPDATE reponse SET LIB_REPONSE_A=$reponse_A, LIB_REPONSE_B=$reponse_B, LIB_REPONSE_C=$reponse_C, LIB_REPONSE_D=$reponse_D WHERE ID_QUESTION = $id_question";

                        $res1 = $idCnx->exec($sql1);
                        $res2 = $idCnx->exec($sql2);
                        echo "Question modifiée avec succès";
                    }catch(Exception $e){
        ...
        <div class="col-8" >
          <form method="POST" action="">
             <!-- <div class="top-margin">
              ...
              <input type="text" name="id_question"   value="<?php echo @$id_question; ?> "  class="form-control" required disabled>
            </div>
            <div class="top-margin">
              <label>Identifiant du formateur rédigeant la question</label>
              <input type="text" name="id_formateur" value="<?php echo @$id_formateur;?> " class="form-control" required disabled >
            </div> -->
            <div class="top-margin"> 
