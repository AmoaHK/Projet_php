...
?>
    ...
    <div id="main-content" class="container allContent-section py-4">
        <div class="row">
                ...
                <h2> <a  style="font-size: 45px; color:dark" href="test.php">Test</a> / Test <?php echo $lib_cat ?>    </h2>
                <?php  
                    ...
                    <div class="container mt-5">
                        ...
                        //print_r($reponses_correctes);
                           ...
                           // echo"reponse_C = ",print_r($reponses_correctes)  ?>
